...
// Marca que uma credencial individual já foi gerada nesta sessão do navegador,
// impedindo novas gerações até que a sessão seja encerrada.
export const CREDENTIAL_GENERATED_COOKIE = "credential_generated";
